...
const ATTR_ALIASES: Record<string, string> = {
  ...
  printtype: "print_or_pattern_type",
  printorpatterntype: "print_or_pattern_type",
  printorpattern: "print_or_pattern_type",
  occasion: "occasion",
  neck: "neck",
  necktype: "neck",
  neckline: "neck",
  ...
  sleevetype: "sleeve_length",
  fit: "fit_shape",
  shape: "fit_shape",
  fitshape: "fit_shape",
  fittype: "fit_shape",
  type: "generic_name",
  producttype: "generic_name",
...
export function AIAutofill() {
  ...
  useEffect(() => {
    const onSetReferenceSku = (event: Event) => {
  ...
  const businessEmpty =
    !!business &&
    Object.values(businessDetailsToFields(business)).length === 0;
