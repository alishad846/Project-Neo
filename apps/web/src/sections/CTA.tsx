...
export function CTA() {
  ...
  return (
    <section className="comic-panel comic-yellow section-fade-top relative mt-12 w-full overflow-hidden rounded-t-[2.5rem] pt-24 text-black md:mt-20 md:pt-32">
      <div
        ref={ref}
        className={`relative z-10 mx-auto flex max-w-6xl flex-col items-center px-6 pb-24 text-center md:pb-32 reveal ${
          visible ? "reveal-visible" : ""
        }`}
      >
        <h2
          className="mb-4 font-display text-4xl text-black heading-pop-pink sm:text-5xl md:text-7xl"
        ...
        <p className="mb-10 max-w-xl font-cartoon text-xl text-black/80">
          One catalog, every marketplace you sell on. Grab Neo Pro at the
          launch price — ₹999, down from ₹3999.
        </p>
